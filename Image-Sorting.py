...
def get_model(name, params):
    ...
    if name == "KNN":
        ...
        # We will define KNN model using sklearn KNeighborsClassifier object 
...
def get_model_results(model_name, params, train_data, train_labels, test_data, test_labels, num_class):
    ...
    acc = metrics.accuracy_score(prediction,test_labels)

    # 5. Calculate the confusion matrix by using the completed the function above 
    conf_mat = conf_matrix(prediction,test_labels,num_class)
